...
function chkUser() {
	...
	if (tempName == null || tempName == '' || tempName == 'undefined') {
		...
		if (
			...
			errH.innerHTML = tempName + ", C'est quoi le mot de passe"; // display this text
...
function askPass() {
	...
	errH.innerHTML = tempName + ", C'est quoi le mot de passe "; // display this line with user's name
}
